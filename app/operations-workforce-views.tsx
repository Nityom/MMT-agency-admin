...
export function AttendanceView({ store, attendanceDate, attendanceDirty, attendanceRows, activeEmployeeIds, selectAttendanceDate, markAllPresent, setEmployeeAttendance, saveAttendance, attendanceReportFrom, attendanceReportTo, setAttendanceReportFrom, setAttendanceReportTo }: AttendanceViewProps) {
