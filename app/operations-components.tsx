...
export function FormField({ label, name, type = "text", defaultValue, required = false, min, placeholder, autoFocus }: { label: string; name: string; type?: string; defaultValue?: string | number; required?: boolean; min?: number | string; placeholder?: string; autoFocus?: boolean }) {
